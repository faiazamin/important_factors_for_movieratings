...
```
So we can not choose both. **Here I will take critics_score because it serves a better model.**

* * *
## Part 4: Modeling
Now I will use **backward elemination** on adjusted R squares to chose my model.

I have selected director, audience_score, critics_score, best_pic_win variables for calculating model *parsimony*.
